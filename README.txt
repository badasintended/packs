  ...
  GitHub Repository     : https://github.com/deimosbtg/packs/tree/chairs
  by DeimosBTG
  ...
  >> HOW TO, CHAIRS?
    Crafting recipe is:
     --------------
    | ██ |    |    |
    |----|----|----| ██: Wood planks or cobblestones
    | ██ | ██ | ██ |     This will gives you knowledge book and will replaced with heads
    |----|----|----|     The "true" crafting recipe coming after Mojang implement NBT otput!
    | ██ |    | ██ |
     --------------
    To remove them, simply left click
